  ...
  return (
    <>
      ...
      <section className='text-gray-700 border-t border-gray-200'>
        <div className='container px-5 py-24 mx-auto'>
          <div className='text-center mb-20'>
            ...
            <p>以下に個人としての成果物を公開しています。主にSNSなどのChatアプリの構築をReactやJSやTSで実装しています。また、PYthonを使ってAIによる
      ...
      <section className='text-gray-700 border-t border-gray-200'>
        ...
        <h2>JavaScript</h2>
        <div className='shadow bg-green-100 mt-2 w-full'>
          <div className='bg-orange-400 text-xs leading-none py-1 text-center text-white' style={{ width: "20%" }}>20%</div>
        </div>
        <h2>React</h2>
        <div className='shadow bg-green-100 mt-2 w-full'>
          <div className='bg-blue-400 text-xs leading-none py-1 text-center text-white' style={{ width: "15%" }}>15%</div>
        </div>
        <h2>Python</h2>
        <div className='shadow bg-green-100 mt-2 w-full'>
          <div className='bg-yellow-300 text-xs leading-none py-1 text-center text-gray-400' style={{ width: "0%" }}>0%</div>
        </div>
      </section>
    </>
  )
